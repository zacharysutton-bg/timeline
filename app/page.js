  ...
  return (
    <VerticalTimeline lineColor='lightgray' layout='2-columns'>
      ...
      >
        ...
        <p>
          German Carl Voelker sets up an outdoor gymnastic school near Regents Park London. Unfortunately, it does not survive beyond 1830, but the later formed
          Primrose Hill Gymnasium supported by the Ministry of Parks has better success.
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
        className='vertical-timeline-element--work'
